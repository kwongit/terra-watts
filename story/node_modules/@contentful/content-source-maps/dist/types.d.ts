...
export type CPAMappings = Record<string, {
    source: CPASource;
}>;
export type GraphQLMappings = Record<string, {
    source: GraphQLSource;
}>;
export type FieldType = 'Symbol' | 'Text' | 'RichText' | 'Array';
export type WidgetId = 'multipleLine' | 'boolean' | 'objectEditor' | 'datePicker' | 'locationEditor' | 'checkbox' | 'listInput' | 'rating' | 'radio' | 'tagEditor' | 'numberEditor' | 'urlEditor' | 'slugEditor' | 'singleLine' | 'dropdown' | 'entryLinkEditor' | 'entryCardEditor' | 'entryLinksEditor' | 'entryCardsEditor' | 'assetLinkEditor' | 'assetLinksEditor' | 'assetGalleryEditor' | 'richTextEditor' | 'markdown' | string;
export type WidgetNamespace = 'builtin' | 'extension' | 'sidebar-builtin' | 'app' | 'editor-builtin';
...
export type CPAContentSourceMaps = Pick<ContentSourceMaps, 'sys'> & {
    mappings: CPAMappings;
};
...
export interface CPAEntry<TFields extends EntrySkeletonType = EntrySkeletonType> extends ContentfulEntry<TFields> {
    sys: ExtendedSys;
    fields: TFields['fields'];
}
export interface CPAEntryCollection<TFields extends EntrySkeletonType = EntrySkeletonType> extends ContentfulEntryCollection<TFields> {
    sys: {
        type: 'Array';
        contentSourceMapsLookup?: ContentSourceMapsLookup;
    };
